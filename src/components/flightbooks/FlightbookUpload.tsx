    ...
    <div className="space-y-6 max-w-xl">
      <div>
        ...
        <p className="mt-1 text-sm text-[var(--easa-color-text-muted)]">
          Import a PDF, DOC, DOCX, TXT, MD, or JSON fixture. The full file is preserved through section parsing or full-document chunking and then indexed for AI regulation comparison.
        </p>
      </div>
      ...
      <div className="easa-card p-4 text-xs text-[var(--easa-color-text-muted)] space-y-1">
        ...
        <p><strong className="text-[var(--easa-color-text-secondary)]">DOC / DOCX</strong>: Word text extracted, then stored by detected sections or full-document chunks if headings are unreliable</p>
