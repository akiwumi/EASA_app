...
import { categoryToPart } from "@/lib/ai/retrieval";
import { createHash } from "crypto";
import {
  generateDraftPreview as generateReadOnlyDraftPreview,
  generateDraftPreviewForFinding as generateReadOnlyDraftPreviewForFinding,
} from "@/lib/ai/proposed-update-preview";
...
export async function generateDraftPreviewForFinding(
  ...
  return generateReadOnlyDraftPreviewForFinding(admin, input);
}
...
export async function generateDraftForProposedUpdate(
  ...
  const preview = await generateReadOnlyDraftPreview(admin, {
