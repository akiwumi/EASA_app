  ...
  // ─── Flight Books & Manuals ─────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "After upload, the system parses your document into sections. For PDF, DOC, and DOCX files, section boundaries are detected from headings and numbered paragraphs. For Markdown, headings (##, ###) define sections directly.",
