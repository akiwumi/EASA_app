          ...
          <form className="mt-6 min-w-0 space-y-4 sm:mt-8" onSubmit={handleSubmit}>
            <label className="easa-form-label">
              ...
              <input
                ...
                placeholder="admin@easa.local or name@school.org"
                type="text"
                value={email}
            ...
            <label className="easa-form-label">
              ...
              <div className="relative mt-2">
                ...
                <button
                  ...
                  className="absolute right-2 top-1/2 inline-flex -translate-y-1/2 items-center gap-1 rounded-full px-2 py-1 text-xs font-medium text-[var(--easa-color-text-muted)] transition hover:bg-[var(--easa-color-surface-2)] hover:text-[var(--easa-color-text-primary)]"
                  type="button"
