  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes. You can upload your Operations Manual, Training Manual, MEL, or any other document in PDF, DOC, DOCX, TXT, Markdown, or JSON format. The system parses each document into indexed sections so the AI can compare them against updated regulations.",
      },
      {
